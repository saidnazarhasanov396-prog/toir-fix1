...
public final class RolePermissionDefaults {
    ...
    private static Map<String, List<String>> buildDefaults() {
        ...
        defaults.put("TECHNICAL_DIRECTOR", List.of(
                ...
                PermissionConstants.EQUIPMENT_COMMISSIONING_READ,
                PermissionConstants.EQUIPMENT_COMMISSIONING_CREATE,
                PermissionConstants.EQUIPMENT_COMMISSIONING_UPDATE,
                PermissionConstants.EQUIPMENT_COMMISSIONING_SUBMIT,
                PermissionConstants.EQUIPMENT_COMMISSIONING_CANCEL,
                PermissionConstants.METER_READ,
                PermissionConstants.METER_CREATE,
                PermissionConstants.METER_UPDATE,
