...
public class MaintenanceRegulation extends BaseEntity {
    ...
    private com.toir.meter.MeterType triggerMeterType;

    @Column(name = "trigger_meter_interval")
    private Double triggerMeterInterval;

    public com.toir.meter.MeterType getTriggerMeterType() { return triggerMeterType; }
    public void setTriggerMeterType(com.toir.meter.MeterType triggerMeterType) { this.triggerMeterType = triggerMeterType; }
