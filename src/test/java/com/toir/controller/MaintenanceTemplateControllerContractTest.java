...
class MaintenanceTemplateControllerContractTest {
                        ...
                        .content("""
                                {
                                  ...
                                  "equipmentTypeId": "%s",
                                  "equipmentTypeName": "name of equipment type",
                                  "maintenanceKind": "PREVENTIVE",
    ...
    @Test
    void addOperationWithDuplicateSequenceReturnsBadRequest() throws Exception {
        UUID templateId = UUID.randomUUID();
        when(service.addOperation(eq(templateId), any(MaintenanceOperationDto.class)))
                .thenThrow(RestException.badRequest(
        ...
        mockMvc.perform(post("/api/v1/maintenance-templates/{id}/operations", templateId)
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.message")
                        .value("Checklist item sequence must be unique within the same template"));
    }
    ...
    void getStatsReturnsStatsResponse() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/maintenance-templates/stats")
                        .param("search", "pump")
                        .param("type", "PREVENTIVE"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.totalTemplates").value(10))
                .andExpect(jsonPath("$.withOperations").value(7))
                .andExpect(jsonPath("$.totalOperations").value(25))
                .andExpect(jsonPath("$.avgPerTemplate").value(2.5));
    }
}
